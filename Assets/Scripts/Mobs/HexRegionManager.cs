...
public class HexRegionManager : RegionManager
{
    ...
    {
		return Vector2Int.RoundToInt((pos+new Vector2(.01f,.01f))/100);
	...
	private void Start()
	{
		...
		if(Region.HexRegionManager != null)
		{
			Debug.LogError("RegionManager already exists Removing extra");
			Destroy(this);
			return;
		}
		Region.HexRegionManager = this;
